    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 border border-border">
          ...
          <div className="mt-6 text-xs text-muted-foreground bg-gray-50 rounded-2xl p-4">
            <p className="font-semibold mb-1">Akun demo:</p>
            <p>Pelamar: user@kerjole.com / user12345</p>
            <p>Perusahaan: company@kerjole.com / company12345</p>
            <p>Admin: admin@kerjole.com / admin12345</p>
          </div>
